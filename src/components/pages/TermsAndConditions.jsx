            ...
            <div className="contentContainer">
                <div className="content">
                    ...
                    <p style={{ marginTop: "10px" }}>
                        These terms and conditions outline the rules and regulations for the use of A. R Enterprise's Website, located at {props.domain}. <br /> <br />
                        ...
                        <b>Cookies</b> <br />
                        We employ the use of cookies. By accessing {props.domain}, you agreed to use cookies in agreement with the A. R Enterprise's Privacy Policy.
                        <br />
                        Most interactive websites use cookies to let us retrieve the user’s details for each visit. Cookies are used by our website to enable the functionality of certain areas to make it easier for people visiting our website. Some of our affiliate/advertising partners may also use cookies.
                        <br /><br />
                        <b>License</b> <br />
                        Unless otherwise stated, A. R Enterprise and/or its licensors own the intellectual property rights for all material on {props.domain}. All intellectual property rights are reserved. You may access this from {props.domain} for your own personal use subjected to restrictions set in these terms and conditions.
                        <br /><br />
                        You must not: <br /><br />
                        ...
                        Parts of this website offer an opportunity for users to post and exchange opinions and information in certain areas of the website. A. R Enterprise does not filter, edit, publish or review Comments prior to their presence on the website. Comments do not reflect the views and opinions of A. R Enterprise,its agents and/or affiliates. Comments reflect the views and opinions of the person who post their views and opinions. To the extent permitted by applicable laws, A. R Enterprise shall not be liable for the Comments or for any liability, damages or expenses caused and/or suffered as a result of any use of and/or posting of and/or appearance of the Comments on this website. <br /><br />

                        A. R Enterprise reserves the right to monitor all Comments and to remove any Comments which can be considered inappropriate, offensive or causes breach of these Terms and Conditions. <br /><br />
                        ...
                        You hereby grant A. R Enterprise a non-exclusive license to use, reproduce, edit and authorize others to use, reproduce and edit any of your Comments in any and all forms, formats or media. <br /> <br />
                        ...
                        No use of A. R Enterprise's logo or other artwork will be allowed for linking absent a trademark license agreement. <br /><br />
