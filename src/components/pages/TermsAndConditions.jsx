            ...
            <div className="contentContainer">
                <div className="content">
                    ...
                    <p style={{ marginTop: "10px" }}>
                        These terms and conditions outline the rules and regulations for the use of A. R Enterprise's Website, located at hotcharge.in. <br /> <br />

                        By accessing this website we assume you accept these terms and conditions. Do not continue to use HotCharge if you do not agree to take all of the terms and conditions stated on this page.
                        <br /><br />
                        ...
                        <b>Cookies</b> <br />
                        We employ the use of cookies. By accessing HotCharge, you agreed to use cookies in agreement with the A. R Enterprise's Privacy Policy.
                        <br />
                        Most interactive websites use cookies to let us retrieve the user’s details for each visit. Cookies are used by our website to enable the functionality of certain areas to make it easier for people visiting our website. Some of our affiliate/advertising partners may also use cookies.
                        <br /><br />
                        <b>License</b> <br />
                        Unless otherwise stated, A. R Enterprise and/or its licensors own the intellectual property rights for all material on HotCharge. All intellectual property rights are reserved. You may access this from HotCharge for your own personal use subjected to restrictions set in these terms and conditions.
                        <br /><br />
                        You must not: <br /><br />

                        <b>Republish material from HotCharge</b> <br /> <br />
                        Sell, rent or sub-license material from HotCharge <br />
                        Reproduce, duplicate or copy material from HotCharge <br />
                        Redistribute content from HotCharge <br />
